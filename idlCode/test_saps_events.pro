...
fname_saps_raw_north = '/home/bharatr/Docs/data/saps-north-2011-2012.txt' 
			...
			for mltLoopPntr = 0, poesMLTLoopSize[1]-1 do begin
				...
				if (Jinds_Final_SAPS_scatter[0] ne -1 ) then begin
					...
					for fsp = 0, n_elements(Final_SAPS_Lats)-1 do begin
						print, "SAPS --> lats, mlt, vel, eprlat", date_curr, time_curr, Final_SAPS_Lats[fsp], Final_SAPS_Mlts[fsp], Final_SAPS_Vels[fsp], POS_eq_eloval_bnd_this_mlt
						printf,1, date_curr, time_curr, Final_SAPS_Lats[fsp], Final_SAPS_Mlts[fsp], Final_SAPS_Vels[fsp], POS_eq_eloval_bnd_this_mlt[0],POS_eq_eloval_bnd_this_mlt[1], $
	                                                                format = '(I8, I5, 2f9.4, f11.4, I5, 2f9.4)'
					endfor
