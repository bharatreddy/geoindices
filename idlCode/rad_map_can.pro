pro rad_map_can,date_rng=date_rng,plot_both_hemi=plot_both_hemi,plot_south=plot_south,plot_north=plot_north
...
if (~Keyword_set(date_rng)) then begin
	date_rng = [ 20120101, 20120131 ]
	prinfo,'date not set...setting it to entire 2012 year'
endif
...
dt_skip_time=2.d ;;; we search data the grd file every 60 min
