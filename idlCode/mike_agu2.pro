...
ps_open, '/home/bharatr/Docs/plots/mike-plot-tec2-' + strtrim( string(dateSel[0]), 2) + '.ps'
...
rad_load_colortable, /bw
	;;plot tec vectors
	tec_median_filter,date=dateSel,time=timeSel[0]
	overlay_tec_median, date=dateSel, time=timeSel[0], scale=tecScale, coords=coords
...
rad_load_colortable, /bw
plot_colorbar, 1., 1.4, -0.02, 0.4, /square,scale=tecScale,legend='Total Electron Content [TECU]', level_format='(f6.2)',param='power', /left, charsize = 0.5
rad_load_colortable, /website
